    ...
    <div className="page-container">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          ...
          value={mockStats.stainlessSteel}
          icon={<Gem className="w-6 h-6" />}
          iconBgColor="#faf5ff"
          iconColor="#9333ea"
        />
        ...
        <StatCard
          label="Manufacturers"
          value={mockStats.totalManufacturers}
